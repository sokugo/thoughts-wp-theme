					...
					<div class="fat-footer__social">
						<ul class="list-bare list-inline">
							<?php if(theme_option('type-facebook')): ?>
								<li><a href="https://facebook.com/<?php echo theme_option('type-facebook') ?>/"><i class="fa fa-facebook-square" aria-hidden="true"></i></a></li>
							<?php endif ?>

							<?php if(theme_option('type-twitter')):  ?>
								<li><a href="https://twitter.com/<?php echo theme_option('type-twitter') ?>"><i class="fa fa-twitter-square" aria-hidden="true"></i></a></li>
							<?php endif ?>

							<?php if(theme_option('type-instagram')): ?>
								<li><a href="https://instagram.com/<?php echo theme_option('type-instagram') ?>"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
							<?php endif ?>
							...
							<?php if(theme_option('type-linkedin')): ?>
								<li><a href="https://linkedin.com/in/<?php echo theme_option('type-linkedin') ?>"><i class="fa  fa-linkedin-square"></i></a></li>
							<?php endif ?>

							<?php if(theme_option('type-dribbble')):  ?>
								<li><a href="https://dribbble.com/<?php echo theme_option('type-dribbble') ?>"><i class="fa fa-dribbble" aria-hidden="true"></i></a></li>
							<?php endif ?>

							<?php if(theme_option('type-deviantart')): ?>
								<li><a href="https://<?php echo theme_option('type-deviantart') ?>.deviantart.com"><i class="fa fa-deviantart" aria-hidden="true"></i></a></li>
							<?php endif ?>

							<?php if(theme_option('type-reddit')):  ?>
								<li><a href="https://www.reddit.com/user/<?php echo theme_option('type-reddit') ?>"><i class="fa fa-reddit-square" aria-hidden="true"></i></a></li>
							<?php endif ?>
...
<footer class="footer" role="contentinfo">
	...
	<div class="wrapper wrapper--wide split split--responsive">
		...
		<a href="http://pixelrevel.com/themes/wordpress/thoughts">Thoughts v1.0.2</a> by
